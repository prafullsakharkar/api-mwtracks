...
# CORS_ALLOWED_WHITELIST = os.getenv("CSRF_TRUSTED_ORIGINS", "api-mwtracks.onrender.com").split(",")

CORS_ORIGIN_ALLOW_ALL = (
    True  # If this is used then `CORS_ORIGIN_WHITELIST` will not have any effect
)
CORS_ALLOW_CREDENTIALS = True
CSRF_TRUSTED_ORIGINS = os.getenv("CSRF_TRUSTED_ORIGINS", "https://api-mwtracks.onrender.com").split(
    ","
)
